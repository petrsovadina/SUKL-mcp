...
async def get_medicine_resource(
    sukl_code: str, ctx: Context = CurrentContext()
) -> dict:
    """
...
async def get_pharmacies_by_city(city: str, ctx: Context = CurrentContext()) -> dict:
    """
...
async def get_health_resource(ctx: Context = CurrentContext()) -> dict:
    """
...
async def get_top_level_atc_groups(ctx: Context = CurrentContext()) -> dict:
    """
...
async def get_atc_by_level(level: int, ctx: Context = CurrentContext()) -> dict:
    """
...
async def get_atc_code_resource(code: str, ctx: Context = CurrentContext()) -> dict:
    """
...
async def get_atc_subtree(root_code: str, ctx: Context = CurrentContext()) -> dict:
    """
...
async def get_database_statistics(ctx: Context = CurrentContext()) -> dict:
    """
...
async def get_pharmacy_regions(ctx: Context = CurrentContext()) -> list[str]:
    """
...
async def get_pharmacies_by_region(
    region_name: str, ctx: Context = CurrentContext()
) -> dict:
    """
...
async def get_detailed_statistics(ctx: Context = CurrentContext()) -> dict:
    """
